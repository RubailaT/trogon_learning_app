...
class ColorClass {
  ...
  static const Color darkBlack = Color(0xff090A0A);
  static const Color textBlack = Color(0xff333333);
  static const Color shadowBlack = Color(0x1018280D);
  static const Color textGray = Color(0xff9EA2AD);
  static const Color transparent = Colors.transparent;
  static const Color gray = Color(0xff808080);
  static const Color slateGray = Color(0xff85868B);
  static const Color redBright = Color(0xffFF1818);
  ...
  static const Color indigo = Color(0xFF782FF8);
